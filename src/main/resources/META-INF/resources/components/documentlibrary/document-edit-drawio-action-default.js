YAHOO.Bubbling.fire("registerAction", {
    actionName: "onActionEditInDrawio",
    fn: function(node) {
        
        alert('onActionEditInDrawio called.');
        ...
        Alfresco.util.Ajax.jsonGet(
            {
                url: LOOL_GET_TOKEN + "?nodeRef=" + encodeURIComponent(Alfresco.util.NodeRef(node.nodeRef).id) + "&action=edit",
                successCallback: {
